...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ProductViewHolder> {
    ...
    public CartAdapter(Activity con, @NonNull List<Product> options) {
// TODO Auto-generated constructor stub
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AppConstants.cartList.remove(model);
                CartActivity cartActivity = (CartActivity)mcon;
                cartActivity.setTotalAmount(false);
                Toast.makeText(mcon,"Item Removed Successfully",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cartview_item, parent, false);
        Toast.makeText(mcon,"Redirecting to Cart",Toast.LENGTH_SHORT).show();
